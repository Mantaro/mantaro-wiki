...
**Requirements:**<br>
* This command requires either [**Admin** or **DJ** permissions](https://github.com/Mantaro/MantaroBot/wiki/Command-reference-and-documentation#basic-knowledge).
...
**Description:**<br>
This command will pause the music Player or unpause the Player if already paused.<br>
...
**Description:**<br>
This command automatically connects Mantaro to your current Voice-Chat and plays the song you specified. When using a search term Mantaro will give you a list of options, you will need to type the number corresponding to the song you wish to play.<br>
...
* `Top`: Optional. Puts song at the start of the queue. Requires [**DJ** or **Admin** permissions](https://github.com/Mantaro/MantaroBot/wiki/Command-reference-and-documentation#basic-knowledge).
...
**Description:**<br>
This command displays the current queue or the selected page of the queue.<br>

**Subcommand(s):**<br>
* `show`: Shows the current music queue.
* `clear`: Clears the current queue. Needs [**DJ** or **Admin** permissions](https://github.com/Mantaro/MantaroBot/wiki/Command-reference-and-documentation#basic-knowledge).
...
**Description:**<br>
This command removes the given track(s) from the queue.<br>
...
**Description:**<br>
This command repeats the current song or the queue, or disables it.<br>
...
**Description:**<br>
This command will rewind the current song back to the start.<br>
...
**Description:**<br>
This command will rewind the song back by the time given.<br>
...
**Description:**<br>
This command will shuffle the current queue.<br>
...
**Option(s):**<br>
* `Force`: Optional. Whether to skip vote. Requires [**DJ** or **Admin** permissions](https://github.com/Mantaro/MantaroBot/wiki/Command-reference-and-documentation#basic-knowledge).
...
**Requirements:**<br>
* This command requires either [**Admin** or **DJ** permissions](https://github.com/Mantaro/MantaroBot/wiki/Command-reference-and-documentation#basic-knowledge) to stop immediately.
* This command requires you to be connected to the same Voice-Chat as Mantaro.
...
**Option(s):**<br>
* `Volume`: Optional. The volume to use. Values are 4-100. Leave empty to check current volume.
...
* `Extra`: Optional. Extra users you wish to pout.
